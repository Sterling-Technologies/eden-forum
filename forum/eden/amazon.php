...
require_once dirname(__FILE__).'/amazon/sqs/base.php';
require_once dirname(__FILE__).'/amazon/sqs/batch.php';
require_once dirname(__FILE__).'/amazon/sqs/message.php';
require_once dirname(__FILE__).'/amazon/sqs/permission.php';
require_once dirname(__FILE__).'/amazon/sqs/queue.php'; 
...
class Eden_Amazon extends Eden_Class {
	 ...
	 * @param *string
	 * @param *string
	 * @return Eden_Amazon_Sqs
	 */
	public function sqs($accessKey, $accessSecret) {
		//argument test
		Eden_Amazon_Error::i()
			->argument(1, 'string')		//Argument 1 must be a string
			->argument(2, 'string');	//Argument 2 must be a string
		
		return Eden_Amazon_Sqs::i($accessKey, $accessSecret);
	}
