...
class Eden_Amazon_Ec2_Ami extends Eden_Amazon_Ec2_Base {
	 ...
	 * @param string The full path to your AMI manifest in Amazon S3 storage.
	 * @return array
	 */
	public function registerImage($name, $imageLocation) {
	 ...
	 * @return array
	 */
	public function modifyImageAttribute($imageId) {
		//argument 1 must be a string
		Eden_Amazon_Error::i()->argument(1, 'string');
