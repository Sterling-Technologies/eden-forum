...
class Eden_Amazon_Ec2_Instances extends Eden_Amazon_Ec2_Base {
	 ...
	 * @return array
	 */
	public function runInstances($imageId, $minCount, $maxCount) {
		//argument test
		Eden_Amazon_Error::i()
			->argument(1, 'string')		//argument 1 must be a string
			->argument(2, 'int')		//argument 1 must be a integer
			->argument(3, 'int');		//argument 2 must be a integer
	 ...
	 * stopped to started, we charge a full instance hour, even if transitions happen 
