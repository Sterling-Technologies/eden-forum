 ...
 */
class Eden_Multiply_Oauth extends Eden_Class {
	/* Constants
	-------------------------------*/
	const REQUEST_URL 		= 'http://multiply.com/oauth/request-token'; 
	const AUTHORIZE_URL		= 'http://multiply.com/oauth/authorize';
	const ACCESS_URL		= 'http://multiply.com/oauth/access-token';
